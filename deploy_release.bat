...
set exe_file_base_name=read-write-rtb-sn
set exe_folder=..\build-read-write-rtb-sn-Desktop_Qt_5_15_2_MSVC2019_64bit-Release\release
set dest_folder=%1
set ver_str=%2

xcopy .\configs %dest_folder%\configs /Y /E /I
xcopy .\op-scripts %dest_folder%\op-scripts /Y /E /I
